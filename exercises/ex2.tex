...
\vspace*{3mm}
\noindent
\textbf{Code skeleton:} \url{https://github.com/satlecture/kit2025/blob/main/code/src/sdvstp/sdvstp.cc}
...
\subsection{b)}
Repeat the CDCL algorithm for the larger formula $F'$. Again, select branching literals again in the order $x_1,x_2,x_3, ...$. Draw the implication graph at every conflict and give the learned 1-UIP clause. Provide the final assignment.
\begin{align}
	\centering
