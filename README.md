...
* **Tuesday, April 22**: [L1 - Organisation, Introduction, Applications, Encodings, IPASIR](slides/l01-introduction.pdf) _[AI+DS]_
* **Monday, April 28**: [L2 - Tractable Subclasses, Elementary Encoding Methods](slides/l02-encodings.pdf) _[AI]_
* **Monday, May 5**: [L3 - Local Search, Resolution, DP Algorithm, DPLL Algorithm](slides/l03-sls-dpll.pdf) _[DS]_
* **Monday, May 12**: [L4 - Branching Heuristics, Restart Strategies, Clause Learning, Backtracking](slides/l04-heuristics-cdcl.pdf) _[AI]_
* **Monday, May 19**: [L5 - Efficient Unit Propagation, Clause Forgetting, Community Structure, VSIDS](slides/l05-cdcl.pdf) _[AI]_
* **Monday, May 26**: [L6 - Preprocessing and Propagation-based Redundancy](slides/l06-preprocessing.pdf) _[AI]_
* **Monday, June 2**: [L7 - Redundancy and Proof Systems](slides/l07-redundancy-proofs.pdf) _[AI]_
...
* **Monday, July 28**: [L13 - Maximum Satisfiability (MaxSAT) solving](slides/l13-maxsat.pdf) _[AI]_
...
* **Tuesday, May 20**: E1 - discussion of A1, announcement of [A2 (classic and modern SAT solving)](exercises/ex2.pdf) _[AI]_
* **Tuesday, June 3**: E2 - discussion of A2, announcement of [A3 (preprocessing, proofs)](exercises/ex3.pdf) _[AI]_
* **Tuesday, June 17**: E3 - discussion of A3, announcement of [A4 (parallel SAT)](exercises/ex4.pdf) _[AI]_
