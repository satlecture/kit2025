...
\begin{frame}{Lecturers}
	\begin{itemize}\setlength{\itemsep}{1em}
		\item \textbf{Dr. Markus Iser} \hfill\unimp{\quad-- Post-doc at Algorithm Engineering group}\\
		...
		\item \textbf{Dr. Dominik Schreiber} \hfill\unimp{\quad-- Scalable Automated Reasoning (SatRes) group leader}\\
...
\begin{itemize}\setlength{\itemsep}{1em}
	...
	\item Earning \highl{at least 110 points} will improve the grade of your passed oral exam by one step.
\end{itemize}
\end{frame}
