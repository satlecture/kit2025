...
\begin{itemize}\setlength{\itemsep}{1em}
    ...
    % \item \textbf{Unhiding}\footnote{\href{https://link.springer.com/chapter/10.1007/978-3-642-21581-0_17}{2011, Heule et al., Efficient CNF Simplification Based on Binary Implication Graphs}}\\[1pt] Avoid quadratic runtime of repeated unit propagation through randomized depth-first traversal of the binary implication graph and application of the \emph{parenthesis theorem}.
\end{itemize}~\\
\end{block}
\end{frame}
...
\begin{itemize}\itemsep1ex
    ...
    \item Variants and Optimizations of Redundancy Notions
    \item Scheduling of Preprocessing Techniques
\end{itemize}
\end{block}~\\
\begin{block}{Next Session}
    Redundancy Notions in the Context of Proof Systems
\end{block}
\end{frame}
