...
Grid generateRandomGrid(int width, int height, float targetTillableRatio = 0.7, float minTillableRatio = 0.5) {
...
void generateBenchmarks(const std::string& outPath) {
...
int main(int argc, char* argv[]) {
    ...
    //generateBenchmarks("../exercises/sdvstp/benchmarks/");
    //exit(0);
