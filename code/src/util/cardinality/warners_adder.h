...
public:
    WarnersAdder(VariableAllocator& va, const std::vector<int>& unweightedObjectiveLits) : CardinalityEncoding(va, unweightedObjectiveLits),
            _solver(this, va) {
    ...
    WarnersAdder(VariableAllocator& va, const std::vector<ObjectiveTerm>& objective) : CardinalityEncoding(va, objective),
            _solver(this, va) {
